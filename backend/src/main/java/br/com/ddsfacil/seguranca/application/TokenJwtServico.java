...
import br.com.ddsfacil.seguranca.infrastructure.TokenJwtPropriedades;
...
public class TokenJwtServico {
    ...
    public DadosTokenJwt validar(String token) {
        ...
        return new DadosTokenJwt(usuarioId, empresaId, claims.getSubject(), br.com.ddsfacil.usuario.domain.PerfilUsuario.valueOf(perfil), nome);
    }
